  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Garments <span class="caret"></span></a>
...
<!-- END NAVIGATION BAR -->
		...
		<div class="col-md-12 text-center">
			<img src="images/slider.png" align="center" class="responsive" width="100%" style="margin-bottom: 30px;">
		</div>
	...
	<div class="container" >
		<div class="col-md-4" id="cat1">
			<div class="text-center"><img src="product_images/shirt1.jpg" height="300"></div>
			<hr>
			<div>
				<p align="left">
					<b>Picture Name Will Be Here</b><br>
					Stock : 05 <br>
					Price : Rs.350 
					<del>Rs.450</del> 
				</p>
				...
				<div class="text-center">
					<input type="button" name="" value="See More" class="btn btn-primary center-align " align="center">
				</div>
			</div>
		</div>
		...
		<div class="col-md-4">
			<img src="product_images/shirt1.jpg" height="300">
			<hr>
		</div>
		<div class="col-md-4">
			<img src="product_images/shirt1.jpg" height="300">
...
<div class="row col-md-12" id="foot">
	<p>Copyright &copy; 2012-2018 Designed by *********</p>
</div>
</footer>
<!-- End of Footer -->
